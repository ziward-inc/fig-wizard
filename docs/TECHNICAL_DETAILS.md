...
Before association and export, every model-returned bounding box is expanded by 5% of its width on the left and right and 5% of its height on the top and bottom. The expanded box is clamped to the PDF page bounds and recorded in the manifest.
